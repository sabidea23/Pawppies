...
export class ReviewAddComponent implements OnInit {
  ...
  review: Review = {
    name: '', age: undefined, breed: '', university: undefined, author: undefined, reviewImages: []
  };

  constructor(private login: LoginService, private snack: MatSnackBar, private router: Router, private route: ActivatedRoute, private reviewService: ReviewService, private universityService: UniversityService, private sanitazer: DomSanitizer) {
  }
  ...
  formSubmit() {
    this.review.name = this.inputName;
    this.review.age = this.inputAge;
    this.review.breed = this.inputBreed;
  ...
  public isFormValid() {
    return this.inputName && this.inputBreed &&
      this.inputBreed;
  }
