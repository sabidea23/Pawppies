...
@Component({
  selector: 'app-cute-caat',
  templateUrl: './cute-caat.component.html',
  styleUrls: ['./cute-caat.component.css']
})
export class CuteCaatComponent {
  ...
  cuteBreedsName = ['Maine Coon', 'British Shorthair', 'Bengal', 'Munchkin', 'Siamese', 'Persian',
  'Ragdoll', 'Scottish Fold', 'Birman', 'Russian Blue']
  filterBreeds() {
    // @ts-ignore
