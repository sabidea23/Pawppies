...
export class NavbarComponent implements OnInit {
  ...
  constructor(public login: LoginService, public router: Router, public notificationService: NotificationService) {
  ...
  private getNotifications() {
    this.notificationService.getNotificationsByUserId(this.user.id).subscribe(notifications => {
      // @ts-ignore
